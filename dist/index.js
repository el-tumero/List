...
const list = new (0, _listDefault.default)();
list.push("siema");
list.push("witaj");
list.push("hello");
list.push("omg");
console.log(list.getAt(3)) // list.pop()
 // list.pop()
 // list.pop()
 // list.push("hello")
...
},{"./List":"cvy9F","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cvy9F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class List {
    ...
    getAt(id) {
        ...
        for(let i = 0; i < this.length - id - 1; i++)// if(lastItem.getHead() === undefined) throw new Error("Out of range!")
        lastItem = lastItem.getHead();
        return lastItem.getContent();
    }
    push(str) {
        if (this.length === 0) {
            const firstItem = new (0, _itemDefault.default)(str);
            this.head = firstItem;
            this.tail = firstItem;
            this.length++;
            return;
        }
        this.tail = new (0, _itemDefault.default)(str, this.tail);
        this.length++;
    }
    pop() {
...
},{"./Item":"blnwB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"blnwB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Item {
    constructor(content, head, tail){
...
},{}]},["iJYvl","h7u1C"], "h7u1C", "parcelRequire43e1")
